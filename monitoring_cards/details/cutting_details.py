...
def show_cutting_details(page: ft.Page, request_number: str) -> None:
    log(f"[cutting_details] Open details for {request_number}")
    ...
    _open_dialog(page, request_number, "Різка", [header, *items])
