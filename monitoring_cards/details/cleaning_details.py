...
def show_cleaning_details(page: ft.Page, request_number: str) -> None:
    log(f"[cleaning_details] Open details for {request_number}")
    ...
    _open_dialog(page, request_number, "Зачистка", [header, *items])
