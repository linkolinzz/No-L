...
def main(page: ft.Page):
            ...
            if bot_state.is_running:
                ...
                if not bot_state.accounts:
                    ...
                    for acc in bot_state.accounts:
                        ...
                        add_log(f"[Бот] Розвиток кланових навичок...", "lightblue")
                        refresh_logs()
                        await asyncio.sleep(2)
    ...
    page.add(
        ...
        ft.Row([start_btn, status_text], alignment=ft.MainAxisAlignment.SPACE_BETWEEN, vertical_alignment=ft.CrossAxisAlignment.CENTER),
        ft.Divider(height=20, color="transparent"),
